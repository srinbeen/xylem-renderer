...
// ===========================================================================
// Main color passes - GPU cull results, visibility buffer indirection in VS
// ===========================================================================

void ComputeRenderPass::_RenderTrunkPass(nvrhi::IFramebuffer* framebuffer) {
...
void ComputeRenderPass::_RenderLeavesPass(nvrhi::IFramebuffer* framebuffer) {
    const nvrhi::FramebufferInfoEx& fbinfo = framebuffer->getFramebufferInfo();
    const uint32_t numLods = static_cast<uint32_t>(m_Registry.getLodSegments().size());
...
void ComputeRenderPass::_RenderTerrainPass(nvrhi::IFramebuffer* framebuffer) {
    if (m_StageResources.sceneTerrain.indexCount == 0)
        return;
...
bool ComputeRenderPass::_InitTerrainPass(nvrhi::ICommandList* initCL) {
    ...
    bsd.bindings = {
        nvrhi::BindingSetItem::ConstantBuffer(compute_reg::Terrain::kCB_Frame, m_StageResources.frameShared.constantBuffer,
            nvrhi::BufferRange(0, shader_cb::kCullFrameSize)),
        nvrhi::BindingSetItem::ConstantBuffer(compute_reg::Terrain::kCB_Shading, m_Shared->terrainShadingCB()),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_ShadowMap, m_StageResources.shadow.depthTexture),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_ForestDiff, terrainTex[0].diffuse),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_ForestNor,  terrainTex[0].normalMap),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_DirtDiff,   terrainTex[1].diffuse),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_DirtNor,    terrainTex[1].normalMap),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_RockDiff,   terrainTex[2].diffuse),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_RockNor,    terrainTex[2].normalMap),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_SnowDiff,   terrainTex[3].diffuse),
        nvrhi::BindingSetItem::Texture_SRV(compute_reg::Terrain::kTex_SnowNor,    terrainTex[3].normalMap),
        nvrhi::BindingSetItem::Sampler(compute_reg::Terrain::kSampler_Shadow, m_StageResources.shadow.comparisonSampler),
        nvrhi::BindingSetItem::Sampler(compute_reg::Terrain::kSampler_Aniso,  m_Shared->barkSampler()),
    };

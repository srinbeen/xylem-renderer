...
cbuffer FrameCB : register(XY_REG_B_TRADITIONAL_TERRAIN_CB_FRAME)
{
    float4x4 viewProj;
    float4x4 viewMatrix;
...
cbuffer ShadingCB : register(XY_REG_B_TRADITIONAL_TERRAIN_CB_SHADING)
{
    float g_TileSize;
...
Texture2DArray         t_ShadowMap     : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_SHADOW_MAP);
SamplerComparisonState s_ShadowSampler : register(XY_REG_S_TRADITIONAL_TERRAIN_SAMPLER_SHADOW);

Texture2D    t_ForestDiff : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_FOREST_DIFF);
Texture2D    t_ForestNor  : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_FOREST_NOR);
Texture2D    t_DirtDiff   : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_DIRT_DIFF);
Texture2D    t_DirtNor    : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_DIRT_NOR);
Texture2D    t_RockDiff   : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_ROCK_DIFF);
Texture2D    t_RockNor    : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_ROCK_NOR);
Texture2D    t_SnowDiff   : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_SNOW_DIFF);
Texture2D    t_SnowNor    : register(XY_REG_T_TRADITIONAL_TERRAIN_TEX_SNOW_NOR);
SamplerState s_Aniso      : register(XY_REG_S_TRADITIONAL_TERRAIN_SAMPLER_ANISO);
